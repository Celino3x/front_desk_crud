...
if(isset($_FILES['foto_visitante'])){
    ...
    $sql = "INSERT INTO `cad_visitante`(`nome_visitante`,`cpf_visitante`, `rg_visitante`, `empresa_visitante`, `telefone_visitante`, `foto_visitante`) VALUE ('$nome_visitante', '$cpf_visitante', '$rg_visitante', '$empresa_visitante', '$telefone_visitante', '$obs_visitante', '$foto_visitante')";
